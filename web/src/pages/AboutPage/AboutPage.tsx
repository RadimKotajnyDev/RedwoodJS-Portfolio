...
import { Text, Heading, Box, Flex, Image, chakra, shouldForwardProp, Center } from "@chakra-ui/react";
...
const AboutPage = () => {
  return (
    <>
      ...
      {/* @ts-ignore */}
      <Heading as="h1" className="h1-text" align="center" fontSize="7xl">About</Heading>
      <Text></Text>
      <Center>
